 ...
 */
exports.aiGovCleanup = (0, scheduler_1.onSchedule)('every 24 hours', async () => {
    var _a;
    ...
    try {
        ...
        const rules = (((_a = cfgSnap.data()) === null || _a === void 0 ? void 0 : _a.rules) || []);
        // Find AI evals retention rule
        const aiRule = rules.find((r) => r.collection === 'ai_evals_runs') || {
            days: 30,
            autoClean: true,
        };
        console.log(`📋 AI evals retention: ${aiRule.days} days, autoClean=${aiRule.autoClean}`);
    ...
    try {
        ...
        await Promise.all(files.map(async (file) => {
            try {
                ...
                const createdMs = (metadata === null || metadata === void 0 ? void 0 : metadata.timeCreated)
