...
exports.generatePlatformMonthlyReport = void 0;
 ...
 */
exports.generatePlatformMonthlyReport = functions.https.onCall(async (payload, ctx) => {
    var _a, _b, _c;
    ...
    const month = (payload === null || payload === void 0 ? void 0 : payload.month) ||
        (() => {
            const d = new Date();
    ...
    const disputes = await db
        ...
        .get();
    // Aggregate metrics
    let orders = 0, gross = 0, platform = 0, creators = 0;
    ...
    for (const d of paid.docs) {
        ...
        creators += cr;
        // By product
        const pid = o.productId || ((_b = o.product) === null || _b === void 0 ? void 0 : _b.id) || "unknown";
        const title = (_c = o.product) === null || _c === void 0 ? void 0 : _c.title;
    ...
    const refundsTotal = refunded.docs.reduce((a, d) => { var _a, _b; return a + Number(((_b = (_a = d.data()) === null || _a === void 0 ? void 0 : _a.refund) === null || _b === void 0 ? void 0 : _b.amountUsd) || 0); }, 0);
    ...
    doc.text(`Gross: $${gross.toFixed(2)}  |  Platform: $${platform.toFixed(2)}  |  Creators: $${creators.toFixed(2)}`);
    doc.text(`Refunds: $${refundsTotal.toFixed(2)}  |  Disputes: ${disputes.size}`);
    doc.moveDown().text("Top Products:");
    topProducts.forEach((p, i) => doc.text(`${i + 1}. ${p.title || p.id} — $${p.revenueUsd.toFixed(2)} (${p.orders} orders)`));
    doc.moveDown().text("Top Coupons:");
    topCoupons.forEach((c, i) => doc.text(`${i + 1}. ${c.code} — $${c.revenueUsd.toFixed(2)} (${c.orders} orders)`));
    doc.end();
